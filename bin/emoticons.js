...
(function() {
  define(["markov"], function(markov) {
    var emoticons, escapeRegExp, genEmoticon, ourEmoticons, purgeEmoticon, purgeRegex, roboEmoticons, textEmoticons, twitchEmoticons;
    ...
    return {
      replace: function(text, id, author, big) {
        ...
        if (purgeRegex.test(text) && big) {
          ...
          for (key in textEmoticons) {
            value = textEmoticons[key];
            regex = new RegExp(key, 'g');
